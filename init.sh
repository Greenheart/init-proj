...
proj_dir1="/home/sam/Documents/github/force-push-arena-2/"  #main
proj_dir2="/home/sam/Documents/github/force-push-arena/"    #extra


# start atom and firefox in the background and hide their output from nuhup.out log-files and terminal
nohup atom $proj_dir1 $proj_dir2 >/dev/null 2>&1 &
